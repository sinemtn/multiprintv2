...
const AuthenticatedSuratTugasIndexRoute =
  AuthenticatedSuratTugasIndexRouteImport.update({
    id: '/surat-tugas/',
    path: '/surat-tugas/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/surat-tugas/': {
      id: '/_authenticated/surat-tugas/'
      path: '/surat-tugas'
      fullPath: '/surat-tugas/'
    ...
    '/_authenticated/komplain/': {
      ...
      path: '/komplain'
      fullPath: '/komplain/'
      preLoaderRoute: typeof AuthenticatedKomplainIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/chats/': {
