...
import { StockToner } from './data/schema'
...
export function IndexStockToner() {
    const [StockToners, setStockToners] = useState<StockToner[]>([])
    ...
    if (loading) {
        return <div className='p-8 text-center'>Loading Data Stock Toner...</div>
    }
