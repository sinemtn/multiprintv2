...
import { MasterUser } from './data/schema'
...
export function IndexMasterUser() {
    ...
    if (loading) {
        return <div className='p-8 text-center'>Loading Data Master User...</div>
    }
                ...
                <div className='flex flex-wrap items-end justify-between gap-2'>
                    <div>
                        ...
                        <p className='text-muted-foreground'>
                            Daftar list master user.
                        </p>
                    </div>
                    <MainHeaderButton />
                </div>
                <TasksTable data={MasterUsers} />
            </Main>
            <PrinterDialogs />
        </TasksProvider>
    )
