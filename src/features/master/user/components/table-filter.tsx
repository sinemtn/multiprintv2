...
const route = getRouteApi('/_authenticated/master/user/')
type DataTableProps = {
    data: MasterUser[]
}
...
export function TasksTable({ data }: DataTableProps) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            return id.includes(searchValue) || name.includes(searchValue) || role.includes(searchValue) || email.includes(searchValue)
        },
    ...
    return (
        ...
        >
            <DataTableToolbar
                table={table}
                searchPlaceholder='Cari Master User...'
            />
