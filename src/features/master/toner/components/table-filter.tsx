...
const route = getRouteApi('/_authenticated/master/toner/')
type DataTableProps = {
    data: MasterToner[]
}
...
export function TasksTable({ data }: DataTableProps) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            const active = String(row.getValue('active')).toLowerCase()
            const searchValue = String(filterValue).toLowerCase()
            return id.includes(searchValue) || name.includes(searchValue) || category.includes(searchValue) || active.includes(searchValue)
        },
    ...
    return (
        ...
        >
            <DataTableToolbar
                table={table}
                searchPlaceholder='Cari Master Toner...'
            />
