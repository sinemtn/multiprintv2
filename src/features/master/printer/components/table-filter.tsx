...
import { categories, activates } from "../data/data";


// PROGRAM
// const route = getRouteApi('/stock/printer/')
const route = getRouteApi('/_authenticated/master/printer/')
type DataTableProps = {
    data: MasterPrinter[]
}
...
export function TasksTable({ data }: DataTableProps) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            const manufacture = String(row.getValue('manufacture')).toLowerCase()
            const toner = String(row.getValue('toner')).toLowerCase()
            const supplier = String(row.getValue('supplier')).toLowerCase()
            const searchValue = String(filterValue).toLowerCase()
            return id.includes(searchValue) || name.includes(searchValue) || manufacture.includes(searchValue) || toner.includes(searchValue) || supplier.includes(searchValue) 
        },
