...
const route = getRouteApi('/_authenticated/master/sparepart/')
type DataTableProps = {
    data: MasterSparepart[]
}
...
export function TasksTable({ data }: DataTableProps) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            return id.includes(searchValue) || name.includes(searchValue) || active.includes(searchValue)
        },
